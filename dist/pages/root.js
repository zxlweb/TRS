...
var Root = (function (_super) {
    ...
    Root.prototype.interceptor = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/];
        }); });
    };
    Root.prototype.setUpPage = function (manager) {
    ...
    Root.prototype.getInitDataActionImp = function (props) { };
    ...
    Root.prototype.render = function () {
        ...
        if (this.state.client) {
            if (this.props.devTools) {
                var DevTools = this.props.devTools;
                debugPanel =
...
module.exports = react_redux_1.connect(selector)(Root);
