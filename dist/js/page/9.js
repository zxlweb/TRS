...
/***/ function(module, exports, __webpack_require__) {
	...
	var Login = (function (_super) {
	    ...
	    Login.prototype.handelSubmit = function () {
	        var result = _http.post(REQUEST.SUBMIT);
	    };
	    Login.prototype.handleChange = function () {
	    };
	        ...
	        return (React.createElement("div", { id: 'xsrMain' },
	            ...
	            React.createElement("div", { className: 'login' },
	                React.createElement("form", null,
	                    React.createElement("input", { type: "text", placeholder: "输入学员编号", className: "loginField", ref: 'loginInput' }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".loginpage{background:#f7fafc;margin:0;padding:0;background-repeat:no-repeat;background-size:cover;position:fixed;top:0;right:0;bottom:0;left:0;z-index:-1}a{color:#42b983}#app{font-family:Avenir,Helvetica,Arial,sans-serif;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;text-align:center;color:#2c3e50}.reportContainer{margin:10px 10px 0;color:#666;border:1px solid #ddd;border-radius:4px;box-shadow:0 1px 0 #f2f4f5;background:#fff}.err{border:1px solid #ff6384!important}.errmsg{font-size:14px;color:#ff6384}.loginField{line-height:2.5rem;color:#666;background-image:none;border:1px solid #d9d9d9;border-radius:4px;padding:.1rem .5rem;margin:0 auto;box-sizing:border-box}.loginBtn,.loginField{font-size:1rem;background-color:#fff;width:70%;outline:none;height:2.5rem}.loginBtn{display:block;margin:1rem auto;text-align:center;vertical-align:middle;-ms-touch-action:manipulation;touch-action:manipulation;cursor:pointer;border:1px solid transparent;white-space:nowrap;padding:.3rem;line-height:1.5rem;min-width:5rem;border-radius:4px;-webkit-transition:background .2s;transition:background .2s;color:#57c5f7;border-color:#57c5f7}.loginBtn:hover{color:#57c5f7;background-color:#fff;border-color:#57c5f7}", ""]);
